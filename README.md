...
Com a página do doc aberto após clicar no botão abaixo segure CRTL e clique no nome hyperlink<br />desejado para abrir numa próxima guia no PC, e no dispositivo móvel segure sobre aquele e<br />escolha abrir numa outra guia pois ainda não configurei _blank para abrir em outra guia.</pre>
